...
const Cart = () => {
    ...
    const  removeCartHandle=(id,name)=>{
        ...
        toast.success(`${name} is remoed from the`)
    }


  return (
    <>
   <ToastContainer theme='colores'position='top-container'/>
                    ...
                    {products.map((item,i)=>(
                        <Fragment key={i}>
                            ...
                            <div className="row d-flex align-items-center">
                                ...
                                <div className="col-1">
                                    <button className='btn btn-danger' onClick={()=>removeCartHandle(item.id, item.title)}><FaTrash/></button>
                                </div>
                            </div>
                        </Fragment>
                    ))}
